...
<main>
    ...
    <!-- breadcrumb-area -->
    <div class="breadcrumb-area breadcrumb-style-two" data-background="{{asset('site/img/bg/s_breadcrumb_bg01.jpg')}}">
        <div class="container">
            <div class="row">
                    ...
                    <div class="breadcrumb-content">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="shop.html">{{$product->type}}</a></li>
            ...
            <div class="row">
                        ...
                        <div class="shop-details-nav-wrap">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="item-one-tab" data-toggle="tab" href="#item-one" role="tab" aria-controls="item-one" aria-selected="true"><img src="{{ Storage::url($product->image) }}" alt=""></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="item-two-tab" data-toggle="tab" href="#item-two" role="tab" aria-controls="item-two" aria-selected="false"><img src="{{asset('site/img/product/sd_nav_img02.jpg')}}" alt=""></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="item-three-tab" data-toggle="tab" href="#item-three" role="tab" aria-controls="item-three" aria-selected="false"><img src="{{asset('site/img/product/sd_nav_img03.jpg')}}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="item-one" role="tabpanel" aria-labelledby="item-one-tab">
                                    <div class="shop-details-img">
                                        <img style="width: 621px; height: 689px;" src="{{ Storage::url($product->image) }}" alt="product image">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="item-two" role="tabpanel" aria-labelledby="item-two-tab">
                                    <div class="shop-details-img">
                                        <img src="{{asset('site/img/product/shop_details_img02.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="item-three" role="tabpanel" aria-labelledby="item-three-tab">
                                    <div class="shop-details-img">
                                        <img src="{{asset('site/img/product/shop_details_img03.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="shop-details-content">
                        <a href="#" class="product-cat">{{$product->title}}</a>
                        <h3 class="title">{{$product->type}} {{$product->title}}</h3>
                        <div class="rating">
                        ...
                        <p class="style-name">Product Code : {{$product->product_code}}</p>
                        <div class="price">Price : $ {{$product->price}}</div>
                        @if (isset($product->discount))
                        <div class="price">Discount : {{$product->discount}}%</div>
                        <hr>
            ...
            <div class="related-product-wrap">
                ...
                <div class="row related-product-active">
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                <a href="shop-details.html"><img src="{{asset('site/img/product/n_arrival_product01.jpg')}}" alt=""></a>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                ...
                                <a href="shop-details.html"><img src="{{asset('site/img/product/n_arrival_product02.jpg')}}" alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                <a href="shop-details.html"><img src="{{asset('site/img/product/n_arrival_product03.jpg')}}" alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                    ...
                    <div class="col-xl-3">
                        <div class="new-arrival-item text-center">
                            <div class="thumb mb-25">
                                ...
                                <a href="shop-details.html"><img src="{{asset('site/img/product/n_arrival_product04.jpg')}}" alt=""></a>
                                <div class="product-overlay-action">
                                    <ul>
                                        <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
