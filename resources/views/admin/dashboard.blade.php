        ...
        <div class="row">
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="{{asset('admin/images/users/avatar-3.jpg')}}" class="img-responsive rounded-circle" alt="user">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="{{asset('admin/images/users/avatar-2.jpg')}}" class="img-responsive rounded-circle" alt="user">
                        <div class="wid-u-info">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="{{asset('admin/images/users/avatar-1.jpg')}}" class="img-responsive rounded-circle" alt="user">
                        <div class="wid-u-info">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box widget-user">
                    <div>
                        <img src="{{asset('admin/images/users/avatar-10.jpg')}}" class="img-responsive rounded-circle" alt="user">
                        <div class="wid-u-info">
